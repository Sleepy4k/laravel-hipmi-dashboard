      ...
      <div className="flex flex-col">
        <div className="flex flex-col h-screen">
          ...
          <div className="flex flex-grow overflow-hidden">
            <MainMenu className="flex-shrink-0 hidden w-56 lg:p-6 p-12 overflow-y-auto bg-indigo-800 md:block" />
            {/**
             ...
             */}
            <div
              className="w-full px-4 py-8 bg-gray-100 overflow-hidden overflow-y-auto md:p-12"
              scroll-region="true"
            >
              <FlashMessages />
              {children}
