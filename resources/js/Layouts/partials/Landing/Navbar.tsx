import { LandingData, LandingDataStruct } from "@/types";
    ...
    <div className="fixed navbar bg-base-100 z-50 flex justify-center">
      <div className="navbar w-[85vw]">
        ...
        <div className="navbar-end">
          <div className="hidden lg:block relative rounded-2xl overflow-hidden h-[3rem]">
            {logged_in ? (
              <Link
                href={route("dashboard.index")}
                className="btn btn-block bg-custom-yellow dark:text-neutral lg:text-md lg:w-[7rem] w-[5rem]"
              >
                Dashboard
              </Link>
            ) : (
              <Link
                href={route("login")}
                className="btn btn-block bg-custom-yellow dark:text-neutral lg:text-md lg:w-[6rem] w-[5rem]"
              >
                Masuk
              </Link>
            )}
